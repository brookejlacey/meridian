      ...
      <div className="p-4 rounded-lg border border-[var(--card-border)] bg-[var(--card-bg)] space-y-4">
        ...
        {!userAddress ? (
          ...
          <button
            ...
            className="w-full py-3 rounded bg-blue-600 hover:bg-blue-500 disabled:bg-zinc-700 disabled:text-zinc-500 text-white font-medium text-sm transition-colors"
          >
