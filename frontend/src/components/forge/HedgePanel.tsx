      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-2">
          <div>
            ...
            <input
              ...
              placeholder="100000"
              className="w-full px-2 py-1 text-sm bg-zinc-900 border border-zinc-700 rounded focus:border-blue-500 outline-none"
            />
          </div>
          <div>
        ...
        <div>
          ...
          <input
            ...
            placeholder="0x..."
            className="w-full px-2 py-1 text-sm bg-zinc-900 border border-zinc-700 rounded focus:border-blue-500 outline-none font-mono"
          />
        </div>
        ...
        <button
          ...
          className="w-full px-3 py-2 text-sm bg-blue-600 hover:bg-blue-500 disabled:bg-zinc-700 disabled:text-zinc-500 rounded transition-colors"
        >
          {isPending
            ? "Executing..."
            : isApproving
