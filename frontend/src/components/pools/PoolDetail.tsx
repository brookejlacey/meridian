    ...
    <div className="space-y-6">
      ...
      {userAddress && (
        <div className="p-4 rounded-lg border border-blue-500/30 bg-blue-500/5 space-y-2">
          <h3 className="text-sm font-medium mb-3 text-blue-300">Your LP Position</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="p-4 rounded-lg border border-[var(--card-border)] bg-[var(--card-bg)]">
          ...
          <input
            ...
            className="w-full px-3 py-2 rounded bg-zinc-800 border border-zinc-700 text-sm font-mono mb-3 focus:border-blue-500 focus:outline-none"
          />
          <button
            onClick={handleDeposit}
            disabled={!isActive || !depositAmount || isDepositing || isConfirmingDeposit || isApproving}
            className="w-full px-4 py-2 rounded bg-blue-600 hover:bg-blue-500 disabled:opacity-50 disabled:cursor-not-allowed text-sm font-medium transition-colors"
          >
        ...
        <div className="p-4 rounded-lg border border-[var(--card-border)] bg-[var(--card-bg)]">
          ...
          <input
            ...
            className="w-full px-3 py-2 rounded bg-zinc-800 border border-zinc-700 text-sm font-mono mb-2 focus:border-blue-500 focus:outline-none"
          />
          {userShares !== undefined && userShares > 0n && (
            <button
              onClick={() => setWithdrawShares(formatAmount(userShares, 18, 18))}
